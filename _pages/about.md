...
- I lead the [Software Reliability for Concurrent and Distributed Systems](https://se.ewi.tudelft.nl/research-lines/se-for-concurrency/) research line, where my [team](https://burcuku.github.io/home/team/) develops automated software testing and reliability techniques for concurrent and distributed systems. Our research has been funded by personal academic research grants from the [Amazon Research Award](https://www.amazon.science/research-awards/recipients/burcu-kulahcioglu-ozkan) and [Stellar Academic Research Grant](https://research.stellar.org/research-grants). 

- I am the co-PI of the [UBRI program](https://ripple.com/impact/ubri/) at TU Delft (together with [Annibale Panichella](https://apanichella.github.io/)), funded by Ripple. Our lab focuses on testing and debugging of blockchain systems and their applications.
<!-- Our recent work has identified and suggested a fix for [a critical security vulnerability](https://github.com/XRPLF/rippled/pull/4424) in the XRP Ledger, which is awarded by [Ripple's Bug Bounty Program](https://www.tudelft.nl/2023/ewi/st/levin-winter-and-florena-buse-win-ripple-bug-bounty-award).  -->

- As part of the [TU Delft-JetBrains ICAI lab](https://blog.jetbrains.com/research/2023/10/jetbrains-and-tu-delft-launch-the-ai-for-software-engineering-lab/), [AI4SE](https://se.ewi.tudelft.nl/ai4se/), funded by JetBrains, I supervise in the research track on utilizing dynamic analysis to improve software development and quality. 
